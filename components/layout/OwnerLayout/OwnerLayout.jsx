...
const OwnerLayout = () => {
  ...
  const menuItems = [
    ...
    { path: '/owner/users', icon: '👥', label: 'Pengguna' },
    { path: '/owner/products', icon: '📦', label: 'Produk' },
    { path: '/owner/transactions', icon: '💳', label: 'Transaksi' },
    { path: '/owner/analytics', icon: '📈', label: 'Analitik' },
    { path: '/owner/reports', icon: '📄', label: 'Laporan' },
    { path: '/owner/settings', icon: '⚙️', label: 'Pengaturan' },
  ];
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto flex flex-col">
          ...
          <div className="px-3 mb-4">
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg px-3 py-2 border border-blue-100 dark:border-blue-800">
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-0.5">Role</p>
              <p className="text-sm font-semibold text-blue-600 dark:text-blue-400">Owner / Pemilik</p>
            </div>
          </div>
